...
const T = {
  ru: {
    ...
    'p.seo.promo': '+ SEO + GEO (генеративная оптимизация, Generative Engine Optimization)',
    'p.seo.promo.price': 'от 10 000 ₽',
    'p.seo.audit': '+ SEO-аудит сайта (разово)',
    'p.seo.audit.price': 'от 7 000 ₽',
    'p.photo.ai': '+ Фотосессия ИИ (для человека или товаров)',
  ...
  en: {
    ...
    'p.seo.promo': '+ SEO + GEO (Generative Engine Optimization)',
    'p.seo.promo.price': 'from $150',
    'p.seo.audit': '+ SEO audit (one-time)',
    'p.seo.audit.price': 'from $90',
    'p.photo.ai': '+ AI photoshoot (for a person or products)',
